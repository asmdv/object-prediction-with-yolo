...
def main(args):
    ...
    val_track_histories_numpy = [np.array(v) for v in val_track_histories]
    test_track_histories_numpy = [np.array(v) for v in test_track_histories]

    print("Train: ", len(track_histories_sum_numpy))
    print("Validation: ", len(val_track_histories_numpy))
    # s = 0
    # for e in val_track_histories_numpy:
    #     s += len(e)
    # print("Valdiation points:", s)
    # return
