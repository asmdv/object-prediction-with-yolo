...
def main(args):
    ...
    past_frame_len = 20
    input = args.input
    input_name = extract_filename(input)
    output = args.output
    ...
    with open(f'track_history_{input_name}.pkl', 'wb') as f:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input', type=str, help='First number')
    parser.add_argument('--output', type=str, help='Second number')
